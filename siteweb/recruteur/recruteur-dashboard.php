...
$pageTitle = 'Tableau de bord Recruteur - TGTravail';
...
<div class="dashboard-wrapper">
  ...
  <main class="dashboard-content-main">
    ...
    <!-- Topbar -->
    <div class="dashboard-topbar" style="display:flex; justify-content:space-between; align-items:center; margin-bottom:2rem; flex-wrap:wrap; gap:1rem;">
      <div class="dashboard-header-left">
        ...
        <div>
          <h1 class="user-greeting">Tableau de bord</h1>
          <p style="font-size: 0.9rem; color: var(--text-muted);">Bienvenue, <?= htmlspecialchars($user['nom'] ?: 'Recruteur') ?> 👋</p>
        </div>
      </div>
      ...
      <div style="display: flex; align-items: center; gap: 1.25rem;">
        <div class="company-selector-dropdown" style="position: relative; cursor: pointer;" onclick="this.querySelector('.dropdown-menu').classList.toggle('show')">
          ...
          <span><?= htmlspecialchars($companyName ?? 'Mon Entreprise') ?></span>
